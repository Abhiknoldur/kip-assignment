...
public class Problem5 {
    ...
    public static void main(String[] args) {
        ...
        list.add(new Movie("Game Of Thrones", 2016, 9, "Suspense"));
          ...
          List querylist=  list.stream().filter(r->r.rating>8 && r.genre.equals("Comedy")).map(r->r.name).collect(Collectors.toList());
          System.out.println("all the movies with rating more than 8 and genre comedy: "+querylist);
