...
*/
 ...
 /* def updateBookByIsbn(isbn:String):ServiceCall[NotUsed, String]*/
  ...
  override def descriptor: Descriptor = {
    ...
    named("book_service")
      .withCalls(
        restCall(Method.POST, "/book/create/:isbn/:name/:age", createBook _),
   /*     restCall(Method.GET, "/book/details/isbn/:isbn", getBookByIsbn _),*/
        restCall(Method.GET, "/book/details/name/:name", getBookByName _)/*,
        restCall(Method.PUT,"/book/update/updatedName/:updatedName",updateBookByIsbn _)*/
      ).withAutoAcl(true)
  }
}
